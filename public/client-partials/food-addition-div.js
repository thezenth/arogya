function foodAdditionDiv() {
  ...
  <div class="row">
    <div class="input-field col s12">
      <textarea id="foodComments" class="materialize-textarea"></textarea>
      <label for="foodComments">Comments</label>
    </div>
  </div>
  ...
  <button onclick="addBasicFoodToMeal()">Add Food</button>
  <!-- If implementing full food w/nutrition entry, change onclick to constructFood() -->
  `);
}

/* This code allows for the addition of extra fields
